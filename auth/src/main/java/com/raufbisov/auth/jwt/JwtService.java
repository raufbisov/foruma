...
public class JwtService {
    ...
    public String generateToken(UserCredential userCredential) {
        return generateToken(userCredential, new HashMap<>());
    }

    public String generateToken(UserCredential userCredential, Map<String, Object> extraClaims) {
    ...
    public boolean isTokenValid(String token, UserCredential userCredential) {
        ...
        return (tokenUsername.equals(userCredential.getUsername())) && !isTokenExpired(token);
    }
